...
import { BookOpen, Code2, FileCode, LifeBuoy, NetworkIcon } from "lucide-react";
  ...
  return (
    <>
      ...
      <SidebarInset className={"ml-6 mt-6"}>
        <div className="mb-6">
          <h1 className="text-4xl font-bold">Elias4044 Docs</h1>
          <p className="text-muted-foreground mt-2 max-w-2xl">
            Here you find all documentaition for this app and its services.
          </p>
        </div>

        <div>
          
          <Link href="/docs/elias4044/api" className="flex items-center p-3 rounded-lg border bg-card hover:bg-accent hover:text-accent-foreground transition-all group"><NetworkIcon className="pr-2"/>API Docs</Link>
        </div>
